...
@section('content')
    ...
    <style>
        ...
        .cloud {
            background-image: linear-gradient(rgba(255, 255, 255, .35), rgba(255, 255, 255, .35)), url('https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1094&q=80');
            width: 100%;
        ...
        .cloudd {
            background-image: linear-gradient(rgba(255, 255, 255, .35), rgba(255, 255, 255, .35)), url('https://images.unsplash.com/photo-1549916978-e3954eda7be0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=675&q=80');
            width: 100%;
            background-position: center;
            background-size: cover;
            background-repeat: no-repeat;
    ...
    <div class="flex flex-wrap overflow-hidden color-text">

        <div class="w-full h-screen overflow-hidden md:w-1/2 lg:w-1/2 xl:w-1/2">
            <div class="content">
                <div class="heading">YOGA RECOMMENDATION SYSTEM</div>
        ...
        <div class="w-full h-screen overflow-hidden md:w-1/2 lg:w-1/2 xl:w-1/2">
            <div class="">
                <div class="cloud flex justify-center content-center flex-col">
                    <p class="h1 gl">
                        " Yoga is a light, which once lit will never dim. The better your practice, the brighter your flame
                        "
                    </p>
                    <p style="text-align: right;">- B.K.S Iyengar </p>
                </div>
            </div>
        </div>
    ...
    <div class="flex flex-wrap overflow-hidden color-benefits">
        <div class="w-full h-screen overflow-hidden md:w-1/2 lg:w-1/2 xl:w-1/2">
            <div class="">
                <div class="cloudd flex justify-center content-center flex-col">
                    <p class="h1 gl">
                        " Yoga is not a religion, it is a science, science of well being, a science of youthfulness, a
        ...
        <div class="w-full h-screen overflow-hidden md:w-1/2 lg:w-1/2 xl:w-1/2 color-text">
            ...
            <div class="contentt">
                ...
                <p class="content-desc">➼ If you enable your energies to become exuberant and ecstatic, your sensory body
                    expands.</p>
                <p class="content-desc">➼ Yoga as a practice has innumerable benefits that positively affects an individual
                    both physically and mentally. Whether it is reducing your blood pressure or raising your pain tolerance.
                </p>
                <p class="content-desc">➼ Regular practice of yoga will enhance your ability to balance the poses in the
                    class and focus well outside the class.</p>
                <p class="content-desc">➼ Yoga helps you relax your mind completely. It helps you work on unnecessary
                    tensions, thus facilitating better sleep.</p>
    ...
    <div class="flex flex-wrap overflow-hidden items-center align-center h80 color-contact" id="contactUs">

        <div class="w-full overflow-hidden sm:w-full md:w-1/2 lg:w-1/2 xl:w-1/2 p-10">
            <!-- Column Content -->
        ...
        <div class="w-full overflow-hidden sm:w-full md:w-1/2 lg:w-1/2 xl:w-1/2">
            <!-- Column Content -->
            <form class="flex flex-col items-center align-center my-10">
                <div class="title text-center mb-4">Contact Us</div>

                <!-- Name -->
                <div class="form-group position-relative py-2">
                    <label for="formName">
                        <i class="icon" data-feather="user"></i>
                    </label>
                    <input type="text" id="formName" class="input-contact form-control form-control-lg thick p-2"
                        placeholder="Name">
                </div>
                ...
                <div class="form-group position-relative py-2">
                    ...
                    <input type="email" id="formEmail" class="input-contact form-control form-control-lg thick p-2"
                        placeholder="E-mail">
                </div>

                <!-- Message -->
                <div class="form-group position-relative py-2">
                    <textarea id="formMessage" class="input-contact form-control form-control-lg thick p-2" rows="7"
                        placeholder="Message"></textarea>
                </div>

                <!-- Submit btn -->
                <div class="text-center ">
                    <button type="submit" class="contact-button btn btn-primary bg-yellow-400" tabIndex="-1"><span
    ...
    <div class="w-full h20  relative flex flex-row items-center color-footer">
